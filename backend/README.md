...
## Project Structure
    ...
    ├── testapiautostorybo_111642  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_111642`
...
2. Clone this repo and `cd testapiautostorybo_111642`
